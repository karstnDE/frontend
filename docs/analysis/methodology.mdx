...
YOU SCAN SKIP THIS IF YOU ARE NOT INTERESTED IN THE DETAILS AND JUST WANT TO SEE THE DATA
...
### Pool Identification -- AI TO CHECK THIS SECTION (REMOVE COMMENT AFTERWARDS). I think we do not use pattern matching? If we do, explain better
...
Data Quality is paramount for a project like this. I spend a lot of time on ensuring that the numbers are exact and make sense. There are different ways to do that.
