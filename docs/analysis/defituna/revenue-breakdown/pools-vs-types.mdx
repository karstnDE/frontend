...
<BrowserOnly fallback={<LoadingSpinner />}>
  {() => {
    ...
    function PoolTypeMatrix() {
      ...
      const handleSegmentClick = (poolId, poolLabel, typeName) => {
        setSelectedSegment({ poolId, poolLabel, typeName });
      };
        ...
        <div style={{ padding: '24px 0' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                <span>
                  ...
                  {selectedSegment.typeName && (
                    <>
                      <span style={{ margin: '0 8px', color: 'var(--ifm-color-secondary)' }}>→</span>
                      <span style={{ color: 'var(--accent)' }}>{selectedSegment.typeName}</span>
                    </>
                  )}
                </span>
                <button
          ...
          {!loading && (
            <TopTransactionsTable
              ...
              typeFilter={selectedSegment?.typeName}
              summary={summary}
            />
          )}
        </div>
