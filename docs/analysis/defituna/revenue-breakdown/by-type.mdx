...
export function TypeRevenueDashboard() {
  ...
  return (
    <div style={{ padding: '24px 0' }}>
      {/* Revenue Breakdown Chart - Type View */}
      <BreakdownChart
        summary={summary}
        groupMode="type"
      ...
      {selectedTypeLabel && (
        <div style={{
          ...
          <span style={{ fontSize: '14px', color: 'var(--ifm-color-secondary)' }}>
            Filtered by: <strong>{selectedTypeLabel}</strong>
          </span>
          <button
            onClick={clearFilter}
            style={{
      ...
      <TopTransactionsTable
        ...
        selectedFilterLabel={selectedTypeLabel}
        summary={summary}
      />
    </div>
  );
